...
function Slider({ className, ...props }: ComponentProps<typeof SliderPrimitive.Root>) {
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="block size-4 rounded-full border border-amber-100/80 bg-amber-200 shadow-[0_0_12px_rgba(251,191,36,0.55)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300" />
    </SliderPrimitive.Root>
  )
}
