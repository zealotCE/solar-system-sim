...
An interactive 3D Solar System with a future-observatory aesthetic: eight planets and Pluto, 26 natural satellites, 9 featured minor bodies/comets, 18 notable spacecraft, the main asteroid and Kuiper belts, ephemeris-driven positions, and a 1950–2050 time machine. It supports strict true scale and Chinese, bilingual, or English interfaces. Positions and time are reconstructed from bundled public JPL data for visualization; they are not live measurements.
...
- **Strict true-scale mode:** radii and orbits share one km-to-scene mapping with no physical volume magnification (the Sun’s radius is about 1/215 of Earth’s orbital radius), and spacecraft use their published deployed spans. A translucent 28–44 px locator identifies a distant craft, then retires as inward zoom reveals the metre-scale physical model. A deep near plane and locally rebased paths support continuous travel from the system overview to spacecraft-surface scale
