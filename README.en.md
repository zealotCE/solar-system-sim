...
- **Roman launch update:** the Nancy Grace Roman Space Telescope enters the time machine on NASA’s confirmed 30 August 2026 launch date. It is absent from the physical scene before launch, then moves away from Earth along a clearly disclosed representative 90-day Sun–Earth L2 transfer rather than pretending to provide live navigation. Its archive covers the roughly nine-month schedule gain, 2.4-metre mirror, Hubble-class resolution with a roughly 100-times-wider field, and coronagraph demonstration; the scene uses NASA’s official lightweight GLB
