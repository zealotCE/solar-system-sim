...
- **罗曼望远镜发射更新**：南希·格蕾丝·罗曼空间望远镜按 NASA 确认的 2026 年 8 月 30 日发射日期加入时间机器；发射前不会出现在物理场景，发射后沿明确标注为“示意而非实时测轨”的约 90 天日地 L2 转移逐步离开地球。档案收录提前约九个月发射、2.4 米主镜、百倍哈勃视场和日冕仪技术验证，并使用 NASA 官方轻量 GLB
