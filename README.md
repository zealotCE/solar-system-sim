...
- **标签与远景性能预算**：场景标签按整 CSS 像素投影并带 0.75 px 死区，移除在动态 WebGL 上持续重绘的背景模糊；远景直接卸载月球/小天体/航天器的隐藏 DOM 标签、月球实体与局部轨道，以及非选中任务航迹几何。摄像机远离且朝向太阳系中心时，DPR 上限降至 1.2、关闭合成器 MSAA、降低 Bloom 并裁剪小天体轨道；聚焦远方任务或选中目标不受误裁剪
